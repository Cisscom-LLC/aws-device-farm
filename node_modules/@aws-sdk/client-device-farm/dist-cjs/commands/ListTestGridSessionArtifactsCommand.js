...
class ListTestGridSessionArtifactsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListTestGridSessionArtifactsCommand.getEndpointParameterInstructions()));
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.ListTestGridSessionArtifactsRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.ListTestGridSessionArtifactsResultFilterSensitiveLog,
        };
